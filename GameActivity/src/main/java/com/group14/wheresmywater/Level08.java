 ...
 * The Class Level08.
 */
public class Level08 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level08Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level08Resource;
		...
		crankyPos = new Vector2(225,1107);

		ducky1Pos = new Vector2(138,429);

		ducky2Pos = new Vector2(568,442);

		ducky3Pos = new Vector2(213,717);

		soilSize = new Vector2(800,1130);

		inPipePos = new Vector2(715,1030);

		outPipePos = new Vector2(155,964);

		endGameCamFocus = new Vector2(240,897);

		waterPos= new Vector2(400,100);

		bathPos = new Vector2(200,1100);

		// create Object
		createWall();
		createSoil();
		createRock();
		createWater(waterPos.x,waterPos.y, 100);
		createRectPipe();
		createMenu();
		createDuckyEmpty();
		createCranky();
	...
	private void createSoil() {
		...
		touch(bathPos.x-60,bathPos.y-10);
		touch(bathPos.x-30,bathPos.y-10);
		touch(bathPos.x,bathPos.y-10);
		touch(bathPos.x+30,bathPos.y-10);
		touch(bathPos.x+60,bathPos.y-10);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level08.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel08Screen();
		System.out.println("Level08 Dispose");
	}
	...
	protected void createWater(float pX, float pY, int count) {
		...
		for (int i = 0; i < count; i++) {
			Sprite drop = new Sprite(pX, pY, 100, 100, _resource.water_Region,
					_vbom);
			drop.setZIndex(10);
			Rectangle rect = new Rectangle(pX, pY, 10, 10, _vbom);
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel08Screen();
	}
}