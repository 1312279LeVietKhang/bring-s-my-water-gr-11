...
/**
 * The Class Level07Resource.
 */
public class Level07Resource {
	...
	private void loadGraphic() {
		...
		rock_Region = BitmapTextureAtlasTextureRegionFactory.createFromAsset(rockTextureAtlas, resourceManager._activity, "rock_level07.png", 0, 0);
