 ...
 * The Class Level10.
 */
public class Level10 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level10Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level10Resource;
		...
		crankyPos = new Vector2(676,1180);

		ducky1Pos = new Vector2(316,602);

		ducky2Pos = new Vector2(470,606);

		ducky3Pos = new Vector2(670,517);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(405,1230);

		outPipePos = new Vector2(587,1016);

		endGameCamFocus = new Vector2(625,950);

		waterPos= new Vector2(370,150);

		bathPos = new Vector2(638,1170);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level10.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel10Screen();
		System.out.println("Level10 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel10Screen();
	}
}