 ...
 * The Class Level11.
 */
public class Level11 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level11Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level11Resource;
		...
		crankyPos = new Vector2(272,1176);

		ducky1Pos = new Vector2(534,542);

		ducky2Pos = new Vector2(657,933);

		ducky3Pos = new Vector2(100,797);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(515,1186);

		outPipePos = new Vector2(177,1017);

		endGameCamFocus = new Vector2(260,930);

		waterPos= new Vector2(340,140);

		bathPos = new Vector2(234,1176);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level11.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel11Screen();
		System.out.println("Level11 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel11Screen();
	}
}