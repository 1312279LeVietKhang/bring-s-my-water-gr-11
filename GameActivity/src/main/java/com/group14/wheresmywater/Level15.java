 ...
 * The Class Level15.
 */
public class Level15 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level15Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level15Resource;
		...
		crankyPos = new Vector2(220,897);

		ducky1Pos = new Vector2(16,220);

		ducky2Pos = new Vector2(162,586);

		ducky3Pos = new Vector2(573,1220);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(210,1142);

		outPipePos = new Vector2(135,749);

		endGameCamFocus = new Vector2(220,668);

		waterPos= new Vector2(356,104);

		bathPos = new Vector2(192,895);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level15.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel15Screen();
		System.out.println("Level15 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel15Screen();
	}
}