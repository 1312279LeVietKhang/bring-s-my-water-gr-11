 ...
 * The Class Level05.
 */
public class Level05 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The resource. */
	private Level05Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level05Resource;
		...
		crankyPos = new Vector2(236,944);

		ducky1Pos = new Vector2(200,440);

		ducky2Pos = new Vector2(663,454);

		ducky3Pos = new Vector2(694,994);

		soilSize = new Vector2(800,1200);

		inPipePos = new Vector2(308,1100);

		outPipePos = new Vector2(165,797);

		endGameCamFocus = new Vector2(230,720);

		waterPos = new Vector2(400,138);
		// create Object
		createWall();
		createSoil();
		createRock();
	...
	private void createRectPipe() {
		// TODO Auto-generated method stub
		rectPipe = new Rectangle(inPipePos.x,inPipePos.y, 45, 1, _vbom);
	}
	...
	private void createWall() {
		// TODO Auto-generated method stub
		_spriteWall = new Sprite(0, 0, 800,
				1280, _resource.wall_Region, _vbom);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level05.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel05Screen();
	}
	...
	private void excuteCollidesWithPipe(int index) {
		...
		Rectangle rect = new Rectangle(outPipePos.x,outPipePos.y + 80, 5, 5, _vbom);
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel05Screen();
	}
}