 ...
 * The Class Level07.
 */
public class Level07 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level07Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level07Resource;
		...
		crankyPos = new Vector2(200,1095);

		ducky1Pos = new Vector2(112,412);

		ducky2Pos = new Vector2(634,1145);

		ducky3Pos = new Vector2(405,1133);

		soilSize = new Vector2(800,920);

		inPipePos = new Vector2(540,1050);

		outPipePos = new Vector2(111,930);

		endGameCamFocus = new Vector2(210,860);

		waterPos= new Vector2(370,130);

		bathPos = new Vector2(166,1095);

		// create Object
		createWall();
		createSoil();
		createRock();
		createWater(waterPos.x,waterPos.y, 140);
		createRectPipe();
		createMenu();
		createDuckyEmpty();
		createCranky();
	...
	private void createSoil() {
		...
		touch(waterPos.x,waterPos.y);
		touch(waterPos.x,waterPos.y+10);
		touch(waterPos.x+10,waterPos.y+10);
		touch(waterPos.x+20,waterPos.y+10);
		touch(waterPos.x-10,waterPos.y+10);
		touch(waterPos.x-20,waterPos.y+10);
		touch(waterPos.x-10,waterPos.y);
		touch(waterPos.x+10,waterPos.y);
		...
		touch(outPipePos.x+20,outPipePos.y+100);

		touch(outPipePos.x+40,outPipePos.y);
		touch(outPipePos.x+40,outPipePos.y+20);
		touch(outPipePos.x+40,outPipePos.y+40);
		touch(outPipePos.x+40,outPipePos.y+60);
		touch(outPipePos.x+40,outPipePos.y+80);

		touch(outPipePos.x+40,outPipePos.y+100);

		touch(outPipePos.x+10,outPipePos.y);
		touch(outPipePos.x+10,outPipePos.y+20);
		touch(outPipePos.x+10,outPipePos.y+40);
		touch(outPipePos.x+10,outPipePos.y+60);
		touch(outPipePos.x+10,outPipePos.y+80);
		touch(outPipePos.x+10,outPipePos.y+100);

		touch(outPipePos.x+30,outPipePos.y);
		touch(outPipePos.x+30,outPipePos.y+20);
		touch(outPipePos.x+30,outPipePos.y+40);
		touch(outPipePos.x+30,outPipePos.y+60);
		touch(outPipePos.x+30,outPipePos.y+80);
		touch(outPipePos.x+30,outPipePos.y+100);
	...
	private void createRock() {
		// TODO Auto-generated method stub
		_spriteRock = new Sprite(0, 0,800, 1200, _resource.rock_Region, _vbom);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level07.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel07Screen();
		System.out.println("Level07 Dispose");
	}
	...
	private void excuteCollidesWithPipe(int index) {
		...
		Rectangle rect = new Rectangle(outPipePos.x+20,outPipePos.y + 60, 5, 5, _vbom);
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel07Screen();
	}
}