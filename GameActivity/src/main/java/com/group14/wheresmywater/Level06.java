 ...
 * The Class Level06.
 */
public class Level06 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level06Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level06Resource;
		...
		crankyPos = new Vector2(404,1102);

		ducky1Pos = new Vector2(636,337);

		ducky2Pos = new Vector2(284,648);

		ducky3Pos = new Vector2(713,1105);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(592,1137);

		outPipePos = new Vector2(315,955);

		endGameCamFocus = new Vector2(400,880);

		waterPos= new Vector2(225,113);

		bathPos = new Vector2(370,1100);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level06.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel06Screen();
		System.out.println("Level06 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel06Screen();
	}
}