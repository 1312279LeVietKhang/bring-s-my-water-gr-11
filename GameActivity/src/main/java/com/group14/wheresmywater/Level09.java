 ...
 * The Class Level09.
 */
public class Level09 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level09Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level09Resource;
		...
		crankyPos = new Vector2(650,1175);

		ducky1Pos = new Vector2(85,400);

		ducky2Pos = new Vector2(616,370);

		ducky3Pos = new Vector2(382,870);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(124,1087);

		outPipePos = new Vector2(570,1008);

		endGameCamFocus = new Vector2(600,935);

		waterPos= new Vector2(600,100);

		bathPos = new Vector2(620,1172);

		// create Object
		createWall();
		createSoil();
		createRock();
		createWater(waterPos.x, waterPos.y, 40);
		createWater(98,90,40);
		createRectPipe();
		createMenu();
		createDuckyEmpty();
		createCranky();
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level09.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel09Screen();
		System.out.println("Level09 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel09Screen();
	}
}