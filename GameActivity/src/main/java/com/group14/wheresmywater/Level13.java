 ...
 * The Class Level13.
 */
public class Level13 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level13Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level13Resource;
		...
		crankyPos = new Vector2(600,1045);

		ducky1Pos = new Vector2(273,631);

		ducky2Pos = new Vector2(40,1040);

		ducky3Pos = new Vector2(440,630);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(652,732);

		outPipePos = new Vector2(495,871);

		endGameCamFocus = new Vector2(600,795);

		waterPos= new Vector2(362,180);

		bathPos = new Vector2(555,1044);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level13.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel13Screen();
		System.out.println("Level13 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel13Screen();
	}
}