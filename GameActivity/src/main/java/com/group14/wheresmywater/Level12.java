 ...
 * The Class Level12.
 */
public class Level12 extends BaseScene implements IOnSceneTouchListener,
	...
	/** The _resource. */
	private Level12Resource _resource;
	...
	public void createScene() {
		...
		_resource = ResourcesManager.getInstance()._level12Resource;
		...
		crankyPos = new Vector2(209,1165);

		ducky1Pos = new Vector2(427,592);

		ducky2Pos = new Vector2(683,777);

		ducky3Pos = new Vector2(135,835);

		soilSize = new Vector2(800,1100);

		inPipePos = new Vector2(358,1224);

		outPipePos = new Vector2(117,1011);

		endGameCamFocus = new Vector2(207,930);

		waterPos= new Vector2(388,240);

		bathPos = new Vector2(171,1162);
	...
	private void createSoil() {
		...
		touch(waterPos.x,waterPos.y+80);
		touch(waterPos.x-60,waterPos.y+80);
		touch(waterPos.x-40,waterPos.y+80);
		touch(waterPos.x-20,waterPos.y+80);
		touch(waterPos.x,waterPos.y+80);
		touch(waterPos.x+20,waterPos.y+80);
		touch(waterPos.x+40,waterPos.y+80);
		touch(waterPos.x+60,waterPos.y+80);
	...
	private void createBody() {
		...
		BodyProvider.generateBodies("body/body_level12.xml", mPhysicsWorld,
				FIXTURE_DEF);
	}
	...
	public void disposeScene() {
		// TODO Auto-generated method stub
		stopMusic();
		ResourcesManager.getInstance().unloadLevel12Screen();
		System.out.println("Level12 Dispose");
	}
	...
	public void load() {
		// TODO Auto-generated method stub
		ResourcesManager.getInstance().loadLevel12Screen();
	}
}